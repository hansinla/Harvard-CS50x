<?php
    ...
    */
    function sendmail($datetime, $symbol, $name, $transaction, $price)
    {
        // instantiate mailer
        $mail = new PHPMailer();
        ...
        // set From:
        $mail->SetFrom("hansinla@charter.net");

        // set To:
        $mail->AddAddress("hansinla@mac.com");

        // set Subject:
        $mail->Subject = "CS50: Stock transaction confirmation.";

        // set body
        $mail->Body = "<html><body>The following transaction was executed:<br>
                $datetime<br>
                $symbol<br>
                $name<br>
                $transaction<br>
        ...
        $mail->AltBody = "CS50: Stock transaction confirmation.";

        // send mail
        if ($mail->Send() === false)
            apologize("Error in mail request.");
